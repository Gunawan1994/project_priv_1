...
export function KategoriPenelitian(){
      ...
      <Card>
        <CardHeader 
          ...
          icon={
            ...
            <Button href="/landing-page/kategori-penelitian-create" className={classes.btnAdd} variant="success">Tambah</Button>
        </CardHeader>
        <CardBody>
          <Container>
                  ...
                  <BCard.Img
                    ...
                    <BCard.ImgOverlay className="text-center" style={ hoverImg1 }>
                      <div className={classes.cardOverlay}>
                        ...
                        <span className="pr-4">
                          <Button href="/landing-page/kategori-penelitian-create" variant="warning">Edit</Button>
                        </span>
                        <span className="pr-4">
