...
export function Video(){
  ...
  return (
    <>
      <Card>
        <CardHeader 
          title="List Kategori Penelitian"
          icon={
            <ListIcon 
              className={classes.icon} />
          }>
            <Button href="/landing-page/video-create" className={classes.btnAdd} variant="success">Tambah</Button>
        </CardHeader>
        <CardBody>
          <Container>
                  ...
                  <BCard.Img
                    ...
                    <BCard.ImgOverlay className="text-center" style={ hoverImg1 }>
                      <div className={classes.cardOverlay}>
                        ...
                        <span className="pr-4">
                          <Button href="/landing-page/video-create" variant="warning">Edit</Button>
                        </span>
                        <span className="pr-4">
                ...
                <BCard className={classes.cardSize} onMouseEnter={toggleHover2} onMouseLeave={toggleHover2}>
                  <BCard.Img
                    ...
                    <BCard.ImgOverlay className="text-center" style={ hoverImg2 }>
                      <div className={classes.cardOverlay}>
                        <h3 className={classes.cardTitle}>vestibulum lectus mauris ultrices eros in cursus turpis massa tincidunt dui ut ornare lectus sit</h3>
                        <span className="pr-4">
                          <Button href="/landing-page/video-create" variant="warning">Edit</Button>
                        </span>
                        <span className="pr-4">
