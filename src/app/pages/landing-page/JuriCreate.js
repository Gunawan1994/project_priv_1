    ...
    <>
      <Card>
        ...
        <CardBody>
          <Form>
            <Form.Group>
              <Form.Label>Nama Juri</Form.Label>
              <Form.Control placeholder="Nama Juri" />
            </Form.Group>
            <Form.Group>
              <Form.Label>Jabatan Juri</Form.Label>
              <Form.Control placeholder="Jabatan Juri" />
            </Form.Group>
            <Form.Group>
              <Form.Label>
                Latar Belakang Juri
              </Form.Label>
              <Form.Control as="textarea" rows="5" placeholder="Latar Belakang Juri" />
            </Form.Group>
            <Form.Group>
              <Form.Label>
                <h3>Foto Juri</h3>
